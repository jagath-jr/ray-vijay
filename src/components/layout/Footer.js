  ...
  useGSAP(() => {
    ...
    const tl = gsap.timeline({
      scrollTrigger: {
        ...
        start: "top 85%", // Starts animating when the top of the footer hits 85% of the viewport height
        toggleActions: "play none none reverse", // Plays forward on enter, reverses when scrolling back up
      },
    });
    ...
    .fromTo(
      ...
      "-=0.4" // Starts slightly before the column animation finishes
    )
          ...
          <div className="footer-col flex flex-col items-center sm:items-start text-center font-inter sm:text-left">
            ...
            <div className="flex items-center justify-center sm:justify-start gap-4">
              ...
              <a
                href="#"
                aria-label="Facebook"
                className="social-icon bg-[#f0e7d8] hover:bg-[#cba328] text-black hover:text-white transition-colors p-2 rounded-full flex items-center justify-center w-8 h-8"
              >
