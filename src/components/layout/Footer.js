        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="flex flex-col items-center sm:items-start text-center font-inter sm:text-left">
            ...
            <div className="flex items-center justify-center sm:justify-start gap-4">
              ...
              {/* X (Twitter) Icon */}
<a href="#" aria-label="X" className="bg-[#f0e7d8] hover:bg-[#cba328] text-black hover:text-white transition-colors p-2 rounded-full flex items-center justify-center w-8 h-8">
  <svg fill="currentColor" viewBox="0 0 24 24" className="w-4 h-4">
